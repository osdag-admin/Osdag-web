...
export const seatedAngleConfig = {
  ...
  designType: MODULE_KEY_SEAT_ANGLE,
  cameraKey: "SeatedAngle",
  ...
  buildSubmissionParams: (inputs, allSelected, lists, extraState) => {
    ...
    if (connectivity === "Column Flange-Beam-Web" || connectivity === "Column Web-Beam-Web") {
      return {
        ...
        "Connector.Top_Angle": allSelected.topangle_list ? lists.angleList : inputs.topangle_list,
      };
    } else {
      return {
        "Bolt.Bolt_Hole_Type": inputs.bolt_hole_type,
  ...
  inputSections: [
    ...
    {
      title: UI_STRINGS.ANGLE_SECTION,
      fields: [
        {
          key: "angle_list",
          label: UI_STRINGS.SEATEDANGLE,
          type: "customizable",
