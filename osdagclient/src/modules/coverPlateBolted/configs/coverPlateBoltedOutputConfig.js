export const coverPlateBoltedOutputConfig = {
  ...
  modals: {
    ...
    FlangeSpacingDetailsModal: { type: "spacing", buttonText: "Flange Spacing" },
    ...
    BoltFlangeCapacityModal: { type: "details", buttonText: "Flange Bolt Capacity" },
  ...
  modalData: {
    spacing: {
      WebSpacingDetailsModal: [
        { key: "Web_plate.pitch_provided_web_spacing", label: "Pitch Distance (mm)" },
        { key: "Web_plate.end_dist_provided _web_spacing", label: "End Distance (mm)" },
        { key: "Web_plate.gauge_provided _web_spacing", label: "Gauge Distance (mm)" },
        { key: "Web_plate.edge_dist_provided_web_spacing", label: "Edge Distance (mm)" }
      ],
      FlangeSpacingDetailsModal: [
        { key: "Flange_plate.pitch_provided_flange_spacing", label: "Pitch Distance (mm)" },
        { key: "Flange_plate.end_dist_provided _flange_spacing", label: "End Distance" },
        { key: "Flange_plate.gauge_provided _flange_spacing", label: "Gauge Distance (mm)" },
        { key: "Flange_plate.edge_dist_provided_flange_spacing", label: "Edge Distance (mm)" }
      ]
    },
    ...
    details: {
      ...
      BoltFlangeCapacityModal: [
        { key: "Flange_plate.Bolt_Line_flange_bolt_capacity", label: "Bolt Lines " },
        { key: "Flange_plate.Bolt_OneLine_flange_bolt_capacity", label: "Bolts in One Line " },
        { key: "Flange_plate.Bolt_required_flange_bolt_capacity", label: "Bolts Required" },
        { key: "Bolt.Shear_flange_bolt_capacity", label: "Shear Capacity (kN)" },
        { key: "Bolt.Bearing_flange_bolt_capacity", label: "Bearing Capacity (kN)" },
        { key: "flange_bolt.large_grip_flange_bolt_capacity", label: "Large Grip Red.Factor" },
        { key: "flange_plate.red,factor_flange_bolt_capacity", label: "Long Joint Red.Factor" },
      ...
      BoltWebCapacityModal: [
        ...
        { key: "Web_plate.Bolt_OneLine_web_bolt_capacity", label: "Bolts in One Line " },
        { key: "Web_plate.Bolt_required_web_bolt_capacity", label: "Bolts Required" },
