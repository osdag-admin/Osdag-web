  ...
  switch (action.type) {
      ...
      case 'SET_ALL_MODULE_DATA':
          ...
          const newState = {
              ...
              beamList: action.payload.beamList || [],
              columnList: action.payload.columnList || [],
              connectivityList: action.payload.connectivityList || [],
              ...
              weldTypes: action.payload.weldTypes || [],
              weldFab: action.payload.weldFab || [],
      ...
      case 'RESET_MODULE_STATE':
          return {
              ...state,
              // Reset relevant module state properties
              connectivityList: [],
              columnList: [],
              beamList: [],
              materialList: [],
